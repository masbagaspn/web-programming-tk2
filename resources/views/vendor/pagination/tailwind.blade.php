            ...
            <div>
                <p class="text-xs text-gray-700 leading-5">
                    ...
                    @if ($paginator->firstItem())
                        <span class="text-xs font-medium">{{ $paginator->firstItem() }}</span>
                        'to'
                        <span class="text-xs font-medium">{{ $paginator->lastItem() }}</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                    'of'
                    <span class="text-xs font-medium">{{ $paginator->total() }}</span>
                    'results'
                </p>
            </div>
